workspace "Mi Mercado"{
    ...
    model {
            ...
            group "Single Page Applications - Front-end"{
                ...
                spaProvider = container "SPA - Proveedor" "Aplicación web para perfil proveedor" "JavaScript - Angular" "Web Browser" {
                    ...
                    group "prov-private-module" {
                        ...
                        ProvProfileEditComponent = component "ProvProfileEditComponent" "Permite editar el perfil de los usuarios" "Angular"
                        ProvProfilePasswordComponent = component "ProvProfilePasswordComponent" "Permtie modificar la contraseña del proveedor" "Angular"
                        ...
                        ProvCatalogDetailsComponent = component "ProvCatalogDetailsComponent" "Permite gestionar la información de un catalogo especifico" "Angular"
                    ...
                    group "prov-core" {
                        ...
                        ProvDataServicePublic = component "ProvDataServicePublic" "Permite obtener datos publicos para registro"
                    }
                }
        ...
        #Relationships spaProvider--------------------------------------------------
        #--spaProvider
        ProvAppComponent -> ProvLoginComponent "Inicailiza a"
        ProvLoginComponent -> ProvAuthService "Utiliza para iniciar sesion"
        ProvLoginComponent -> ProvSendEmailComponent "En caso de no recordar la contraseña"
        ProvLoginComponent -> ProvRegisterComponent "En caso que el usuario no este registrado"
        ProvRegisterComponent -> ProvRegisterFinalComponent "Completa el registro del proveedor"
        ProvRegisterFinalComponent -> ProvLoginComponent -> "Una vez completado el registro redirige a"
        ProvSendEmailComponent -> ProvRememberVerifyComponent "Completa el proceso de recuperación de contraseña"
        ProvRememberVerifyComponent -> ProvLoginComponent "Redirige una vez se completa la redirección"
        ProvAuthService -> ProvPrivateComponent "Si el usuario es valido"
        ProvAuthService -> msAuth "Realiza peticiones a" "JSON/HTTP"
        ProvCatalogServiceTS -> msMarket "Realiza peticiones a" "JSON/HTTP"
        ProvMyMarketServiceTS -> msMarket "Realiza peticiones a" "JSON/HTTP"
        ProvMyDocumentService -> msMarket "Realiza peticiones a" "JSON/HTTP"
        ProvOriginServiceTS -> msQuotation "Realiza peticiones a" "JSON/HTTP"
        ProvProviderServiceTS -> msProvider "Realiza peticiones a" "JSON/HTTP"
        ProvDataServicePublic -> msData "Realiza peticiones a" "JSON/HTTP"
        ProvPrivateComponent -> ProvHomeComponent "Inicializa en"
        ProvPrivateComponent -> ProvProfileComponent "Permite navegar a"
        ProvPrivateComponent -> ProvMyDocumentsComponent "Permite navegar a"
        ProvPrivateComponent -> ProvCatalogComponent "Permite navegar a"
        ProvCatalogComponent -> ProvCatalogDetailsComponent "Permite ir a"
        ProvPrivateComponent -> ProvQuotesPageComponent "Permite navegar a"
        ProvMyQuotesComponent -> ProvQuotesPageComponent "Hace parte de"
        ProvMyQuotesComponent -> ProvQuotesToAnswerComponent "Permite navegar a"
        ProvMyQuotesComponent -> ProvQuotesAnsweredComponent "Permite navegar a"
        ProvPrivateComponent -> ProvPurchaseOrderComponent "Permite navegar a"
        ProvPurchaseOrderDetailComponent -> ProvPurchaseOrderComponent "Hace parte de"
        ProvHomeComponent -> ProvMyMarketServiceTS "Utiliza"
        ProvCatalogComponent -> ProvMyMarketServiceTS "Utiliza"
        ProvProfileComponent -> ProvProviderServiceTS "Utiliza"
        ProvProfileComponent -> ProvDataServicePublic "Utiliza"
        ProvProfileEditComponent -> ProvProfileComponent "Compone"
        ProvProfilePasswordComponent -> ProvProfileEditComponent "Compone"
        ProvMyQuotesComponent -> ProvMyMarketServiceTS "Utiliza"
        ProvMyDocumentsComponent -> ProvMyDocumentService "Utiliza"
        ProvMyDocumentsComponent -> ProvDataServicePublic "Utiliza"
        ProvPurchaseOrderComponent -> ProvMyMarketServiceTS "Utiliza"
